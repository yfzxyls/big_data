...
import com.soap.zk.lock.Callback;
import com.soap.zk.lock.zk.ZkDistributedLockTemplate;
...
public class ZkReentrantLockTemplateTest {
    ...
    public static void main(String[] args) {
        RetryPolicy retryPolicy = new ExponentialBackoffRetry(1000, 3);
        CuratorFramework client = CuratorFrameworkFactory.newClient("hadoop200:2181,hadoop201:2181,hadoop202:2181", retryPolicy);
        client.start();
